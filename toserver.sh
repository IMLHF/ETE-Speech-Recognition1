...
if [ "$site" == "p40" ]; then
  echo "To $user@$site:/home/zhangwenbo5/worklhf/2020/ETE-Speech-Recognition1/$2"
  rsync -avh -e "ssh -p 22 -o ProxyCommand='ssh -p 8695 zhangwenbo5@120.92.114.84 -W %h:%p'" --exclude-from='.gitignore' ./* zhangwenbo5@ksai-P40-2:/home/zhangwenbo5/worklhf/2020/ETE-Speech-Recognition1/$2
elif [ "$site" == "v100-3" ]; then
  echo "To $user@$site:/home/zhangwenbo5/worklhf/2020/ETE-Speech-Recognition1/$2"
  rsync -avh -e "ssh -p 22 -o ProxyCommand='ssh -p 8695 zhangwenbo5@120.92.114.84 -W %h:%p'" --exclude-from='.gitignore' ./* zhangwenbo5@ksai-v100-3:/home/zhangwenbo5/worklhf/2020/ETE-Speech-Recognition1/$2
